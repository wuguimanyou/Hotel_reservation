<?php  
	...
	$query_order = "
		...
		addr.name as expressName,addr.phone as expressPhone,addr.location_p,addr.location_c,addr.location_a,addr.address as expressAddress,addr.identity
		...
		<table width="97%" class="CP_table " id="order_table">
			 ...
			 <?php  
				...
				while ($row_order = mysql_fetch_object($result_order)) {
					...
					$o_exp_user_id         = $row_order->exp_user_id;   //分销商ID
					...
					$o_agentcont_type      = $row_order->agentcont_type;		//代理结算: 1、代理结算 0、分销商结算
