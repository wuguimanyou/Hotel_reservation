...
<div id="iframe_page">
   ...
   <script language="javascript">$(document).ready(shop_obj.products_property_init);</script>
					...
					<dd>
						<div class="list">
						    <?php if((($owner_general==1 and $create_type==1) or ($owner_general==2 and $create_type==2)) or ($create_type==3)){ ?>
								<a href="product_pro.php?customer_id=<?php echo $customer_id_en; ?>&productpro_id=<?php echo $parent_id; ?>" title="修改">
								 <img src="images/mod.gif" align="absmiddle">
								</a>
								<a href="product_pro.php?customer_id=<?php echo $customer_id_en; ?>&op=del&id=<?php echo $parent_id; ?>" title="删除" onclick="if(!confirm(&#39;删除后不可恢复，继续吗？&#39;)){return false};">
						   ...
						   ?>
							<li>
								<div class="title"><img src="images/jt.gif"><?php echo $p_name; ?></div>
								 <?php if((($owner_general==1 and $create_type==1) or ($owner_general==2 and $create_type==2)) or ($create_type==3)){ ?>
									<div class="opt"><a href="product_pro.php?customer_id=<?php echo $customer_id_en; ?>&op=del&id=<?php echo $p_id; ?>&productpro_id=<?php echo $parent_id; ?>" onclick="if(!confirm(&#39;删除后不可恢复，继续吗？&#39;)){return false};"><img src="images/del.gif"></a></div>
								<?php } ?>
							</li>
							<?php } ?>
						</ul>
	...
	<div class="m_righter">
		<form id="frm_pro" name="frm_pro" class="" method="post" action="save_productpro.php?customer_id=<?php echo $customer_id_en; ?>&adminuser_id=<?php echo $adminuser_id; ?>&owner_general=<?php echo $owner_general; ?>&orgin_adminuser_id=<?php echo $orgin_adminuser_id; ?>">
			<h1>添加产品属性</h1>
			<div class="opt_item">
				<label>属性名称：</label>
