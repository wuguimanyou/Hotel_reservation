...
<table width="100%" align="center" border="0" cellpadding="5" cellspacing="0" class="r_con_table">
	<thead>
		<tr>
			...
			<td width="8%" nowrap="nowrap">排序</br>(按降序排序)</td>
	...
	<tbody>
	  ...
	  ?>
		<tr>
			...
			<td><input class="paixu" id="<?php echo $p_id; ?>" type="text" value="<?php echo $asort_value; ?>" onblur="change_Sort(<?php echo $p_id; ?>,this)"/></td>
...
return;
	...
	//a.after('<img id="ajax_deal" class="ajax_deal" src="__PUBLIC__/img/loading/ajax_small.gif" />');	
	$.ajax({
