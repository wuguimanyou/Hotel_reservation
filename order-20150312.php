...
if(!empty($_GET["op"])){
   ...
   if($op=="status"){
       //完成
	   $query = "select fromuser_app from weixin_commonshop_orders where batchcode='".$batchcode."'";
			   ...
			   ?>
                      <tr>
						   ...
						   <td>
							...
							<p id="p_changeprice_<?php echo $batchcode; ?>"><a href="javascript:show_changeprice('<?php echo $batchcode; ?>',<?php echo $order_count; ?>);" style="cursor:pointer;">改价</a></p>
							...
							<?php } ?>
							<?php if($status==0 and $paystatus==1){ ?>
					  ...
					  <tr style="background:none;display:none" id="tr_changeaddress_<?php echo $batchcode; ?>">
					     <td  colspan=13 style="width:100%;">
						  <table style="width:100%;"><tr><td>
							...
							<select name="location_p_<?php echo $batchcode; ?>" id="location_p_<?php echo $batchcode; ?>" ><option value="<?php echo $location_p; ?>" ><?php echo $location_p; ?></option></select><br>
							<select name="location_c_<?php echo $batchcode; ?>" id="location_c_<?php echo $batchcode; ?>" ><option value="<?php echo $location_c; ?>" ><?php echo $location_c; ?></option></select><br>
							<select name="location_a_<?php echo $batchcode; ?>" id="location_a_<?php echo $batchcode; ?>" ><option value="<?php echo $location_a; ?>" ><?php echo $location_a; ?></option></select><br>
...
<script>
  ...
  function prePage(){
     ...
     document.location= "order.php?pagenum="+pagenum+"&search_status="+search_status+"&begintime="+begintime+"&endtime="+endtime+"&pagesize="+pagesize+"&search_name="+search_name+"&search_batchcode="+search_batchcode+"&search_paystyle="+search_paystyle;
  }
